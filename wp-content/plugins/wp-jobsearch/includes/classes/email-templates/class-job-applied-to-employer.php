    ...
    class jobsearch_job_applied_to_employer_template {
        ...
        public function jobsearch_job_applied_to_employer_callback($user = '', $job_id = '') {
            ...
            if (isset($template['switch']) && $template['switch'] == 1) {
                ...
                $attach_resume_file = isset($email_temps_data['jobsearch_email_template']['job_applied_to_employer']['attach_resume_file']) ? $email_temps_data['jobsearch_email_template']['job_applied_to_employer']['attach_resume_file'] : '';
                $attach_cover_file = isset($email_temps_data['jobsearch_email_template']['job_applied_to_employer']['attach_cover_file']) ? $email_temps_data['jobsearch_email_template']['job_applied_to_employer']['attach_cover_file'] : '';
                ...
                $args = apply_filters('jobsearch_job_applied_to_employer_email_args', $args, $_candidate_id, $job_id);
