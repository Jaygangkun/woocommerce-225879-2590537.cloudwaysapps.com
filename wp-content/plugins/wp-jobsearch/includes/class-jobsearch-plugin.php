...
class JobSearch_plugin
{
    ...
    private function load_dependencies()
    {
        ...
        if (!class_exists('Careerfy_framework')) {
            ...
            $check_theme_pylon = wp_get_theme('pylon');
            if (!class_exists('TGM_Plugin_Activation') && !$check_dt7_theme->exists() && !$check_nanosoft_theme->exists() && !$check_theme_2121->exists() && !$check_theme_pylon->exists()) {
