        ...
        if ($post_type == 'employer') {
            ...
            if (isset($_POST['cusemp_feature_fbckend'])) {
                ...
                if ($cusemp_feature_fbckend == 'on') {
                    ...
                    delete_post_meta($post_id, 'promote_profile_substime');
                }
            }
...
function jobsearch_employers_meta_settings()
{
    ...
    <div class="jobsearch-post-settings">
        ...
        $args = array(
            ...
            'meta_query' => array(
                array(
                    ...
                    'value' => apply_filters('jobsearch_employer_bkend_emp_assign_pkgsarr', array('job', 'cv', 'featured_jobs', 'emp_allin_one', 'urgent_pkg', 'promote_profile', 'employer_profile')),
                    'compare' => 'IN',
                ),
            ),
        );
        ...
        $args = array(
            ...
            'meta_query' => array(
                ...
                array(
                    'key' => 'package_type',
                    'value' => apply_filters('jobsearch_employer_bkend_emp_assign_pkgsarr', array('job', 'featured_jobs', 'emp_allin_one', 'cv', 'urgent_pkg', 'promote_profile', 'employer_profile')),
                    'compare' => 'IN',
                ),
                array(
    ...
    <?php
    do_action('jobsearch_employer_update_bkend_all_fileds', $_post_id);
