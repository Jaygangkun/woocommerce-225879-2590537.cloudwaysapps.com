...
function jobsearch_candidates_meta_settings()
{
    ...
    <div class="jobsearch-post-settings">
                                                ...
                                                <div class="jobsearch-cv-manager-wrap">
                                                    ...
                                                    <div class="jobsearch-cv-manager-text">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                           class="jobsearch-cv-manager-link jobsearch-delbk-user-cv"
                                                           data-id="<?php echo($file_attach_id) ?>" data-uid="<?php echo($_post_id) ?>"><i class="jobsearch-icon jobsearch-rubbish"></i></a>
        ...
        ?>
        <script>
            jQuery(document).on('click', '.jobsearch-delbk-user-cv', function () {
                ...
                if (this_id != '') {
                    ...
                    var request = jQuery.ajax({
                        ...
                        data: {
                            'attach_id': this_id,
                            'user_id': user_id,
                            'action': 'jobsearch_act_user_cvbk_delete',
                        },
                        dataType: "json"
                    });
    ...
    <?php
    do_action('jobsearch_candidate_update_bkend_all_fileds', $_post_id);
