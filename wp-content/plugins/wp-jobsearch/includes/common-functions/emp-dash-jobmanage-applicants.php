            ...
            <div class="jobsearch-applicants-tabs">
                ...
                <div class="applied-jobs-sort">
                    ...
                    <div class="sort-by-option">
                        <form autocomplete="off" id="jobsearch-applicants-form" method="get">
                            ...
                            <ul class="jobsearch-row">
                                ...
                                foreach ($job_applicants_list as $_candidate_id) {
                                    ...
                                    if ($_selected_view == 'grid') { ?>
                                        ...
                                        <?php
                                        $mangjob_list_item = ob_get_clean();
                                        echo apply_filters('jobseacrh_mangaejob_aplicant_listitem_html', $mangjob_list_item, $_candidate_id, $_job_id);
                                    }
                                    $popup_args = array(
                                        'job_id' => $_job_id,
