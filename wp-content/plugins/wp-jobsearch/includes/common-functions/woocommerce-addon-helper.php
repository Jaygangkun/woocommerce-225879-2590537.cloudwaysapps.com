...
class JobSearch_WooAdon_Common_Funcs {
    ...
    public function product_itm_after_addon($html, $pkg_id, $job_id, $colspan = '3') {
        ...
        global $product, $jobsearch_plugin_options;
                ...
                <tr class="wc-prodaddon-info" style="display: none;">
                    <td colspan="<?php echo ($colspan) ?>">
                        ...
                        foreach ($product_addons as $addon) {
                            ...
                            $addon_field_html = $wc_addon_display->get_addon_html($addon);
                            echo apply_filters('jobsearch_wc_paddon_html_in_pkg_itm', $addon_field_html, $addon, $product_id);
