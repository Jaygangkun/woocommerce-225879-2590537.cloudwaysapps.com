    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .jobsearch-elementor-apply-job  a.jobsearch-applyjob-btn:hover, {{WRAPPER}} .jobsearch-elementor-apply-job a.jobsearch-applyjob-btn:focus' => 'color: {{VALUE !important;}}  ',
                ],
            ]
        );
        $this->add_control(
