...
$jobsearch_builder_shortcodes['candidate_listings'] = array(
    ...
    'params' => apply_filters('jobsearch_candidate_listings_sheb_params', array(
        ...
        'cand_filters_loc' => array(
            'type' => 'select',
            'label' => esc_html__("Locations", "wp-jobsearch"),
            'options' => array(
                'yes' => esc_html__('Yes', 'wp-jobsearch'),
                'no' => esc_html__('No', 'wp-jobsearch'),
            ),
            'desc' => esc_html__("Candidates searching filters 'Location' switch.", "wp-jobsearch"),
        ),
        'cand_filters_loc_collapse' => array(
            'type' => 'select',
