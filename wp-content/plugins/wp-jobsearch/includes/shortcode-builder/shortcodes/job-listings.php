...
$jobsearch_builder_shortcodes['job_listings'] = array(
    ...
    'params' => apply_filters('jobsearch_job_listings_sheb_params', array(
        ...
        'job_filters_skill' => array(
            'type' => 'select',
            'label' => esc_html__('Job Skills Filter', 'wp-jobsearch'),
            'desc' => esc_html__('Jobs searching filters "Job Skills" switch.', 'wp-jobsearch'),
            'options' => array(
                'yes' => esc_html__('Yes', 'wp-jobsearch'),
                'no' => esc_html__('No', 'wp-jobsearch'),
            )
        ),
        'job_filters_skill_collapse' => array(
            'type' => 'select',
            'label' => esc_html__('Job Skills Filter Collapse', 'wp-jobsearch'),
            'desc' => '',
            'options' => array(
                'no' => esc_html__('No', 'wp-jobsearch'),
                'yes' => esc_html__('Yes', 'wp-jobsearch'),
