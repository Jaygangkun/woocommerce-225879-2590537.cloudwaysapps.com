                                            ...
                                            if ($pkg_type == 'cv') {
                                                ...
                                                <tr class="pakcge-itm-stats">
                                                    ...
                                                    if ($unlimited_numcvs == 'yes') {
                                                        ...
                                                        <td><?php printf(__('Remaining: %s', 'wp-jobsearch'), $remaining_cvs) ?></td>
                                                        <?php
                                                    }
                                                    ?>
                                                </tr>
                                                ...
                                                <tr class="pakcge-itm-stats">
                                                    ...
                                                    if ($unlimited_numfjobs == 'yes') {
                                                        ...
                                                        <td><?php printf(__('Remaining: %s', 'wp-jobsearch'), $remaining_jobs) ?></td>
                                                        <?php
                                                    }
                                                    ?>
                                                </tr>
                                                <tr class="pakcge-itm-stats">
                                                    ...
                                                    if ($unlimited_numfcrs == 'yes') {
                                                        ...
                                                        <td><?php printf(__('Remaining: %s', 'wp-jobsearch'), $remaining_fjobs) ?></td>
                                                        <?php
                                                    }
                                                    ?>
                                                </tr>
                                                ...
                                                <tr class="pakcge-itm-stats">
                                                    ...
                                                    <td><?php printf(__('Remaining: %s', 'wp-jobsearch'), apply_filters('jobsearch_emp_dash_pkgs_inlist_rrjobs', $remaining_jobs, $pkg_order_id)) ?></td>
                                                </tr>
                                                <?php
                                            }
                                            echo apply_filters('jobsearch_emp_pkgslist_after_types_info', '', $pkg_type, $pkg_order_id);
                                            ?>
