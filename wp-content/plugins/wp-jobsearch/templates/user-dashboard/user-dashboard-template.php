    ...
    <div class="jobsearch-plugin-default-container" <?php echo force_balance_tags($plugin_default_view_with_str); ?>>
        ...
        <div class="jobsearch-row">
            ...
            if ($user_is_candidate) {
                ...
                $candidate_unapproved_textstr = substr($candidate_unapproved_text, 0, 20) . (strlen($candidate_unapproved_text) > 20 ? '...' : '');
                $candidate_unapproved_text = apply_filters('wpml_translate_single_string', $candidate_unapproved_text, 'JobSearch Options', 'Unapproverd Candidate Message - ' . $candidate_unapproved_textstr, $lang_code);
                //var_dump($lang_code);
                ...
                $employer_unapproved_textstr = substr($employer_unapproved_text, 0, 20) . (strlen($employer_unapproved_text) > 20 ? '...' : '');
                $employer_unapproved_text = apply_filters('wpml_translate_single_string', $employer_unapproved_text, 'JobSearch Options', 'Unapproverd Employer Message - ' . $employer_unapproved_textstr, $lang_code);
