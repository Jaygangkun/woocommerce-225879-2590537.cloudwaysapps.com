...
$user_displayname = get_the_title($employer_id);
                    ...
                    <div class="jobsearch-column-12 jobsearch-typo-wrap">
                        ...
                        <span class="jobsearch-jobdetail-listthumb">
                            ...
                            <figcaption>
                                ...
                                ob_start();
                                ?>
                                <h1><?php echo($user_displayname) ?></h1>
                                <?php
                                ...
                                do_action('jobsearch_empdetail_after_followin_btn', $employer_id, 'view1');
                        ...
                        if (!empty($custom_all_fields) || $employer_content != '') { ?>
                            <div class="jobsearch-jobdetail-content jobsearch-employerdetail-content">
                                ...
                                if ($employer_content != '') {
                                    ?>
                                    <div class="jobsearch-content-title">
                                        <h2><?php esc_html_e('Company Description', 'wp-jobsearch') ?></h2>
                                    </div>
