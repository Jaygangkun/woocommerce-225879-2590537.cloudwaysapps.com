...
if ($view_candidate !== false) {
    ...
    echo apply_filters('jobsearch_cand_detail_1_cver_html', $cover_html, $candidate_id);
}
                        ...
                        if ($cand_det_contact_form == 'on') {
                            if (!$cand_profile_restrict::cand_field_is_locked('contactfrm_defields', 'detail_page')) {
                                ...
                                <div class="jobsearch_side_box jobsearch_box_contact_form">
                                    ...
                                    <form autocomplete="off" id="ct-form-<?php echo absint($cnt_counter) ?>"
                                                ...
                                                <li class="jobsearch-column-12">
                                                    ...
                                                    if ($edu_start_metaexist) {
                                                        if ($education_prsnt_datefield_val == 'on') {
                                                            ...
                                                            <small>
                                                                <?php
                                                                $edu_date_str = jobsearch_get_date_year_only($education_start_datefield_val) . (' - ') . esc_html__('Present', 'wp-jobsearch');
                                                                echo apply_filters('jobsearch_candet_resume_educ_date_str', $edu_date_str, $candidate_id, $exfield_counter);
                                                                ?>
                                                            </small>
                                                            <?php
                                                        } else {
                                                            ...
                                                            <small>
                                                                <?php
                                                                $edu_date_str = jobsearch_get_date_year_only($education_start_datefield_val) . ($education_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($education_end_datefield_val) : '');
                                                                echo apply_filters('jobsearch_candet_resume_educ_date_str', $edu_date_str, $candidate_id, $exfield_counter);
                                                                ?>
                                                            </small>
                                                            <?php
                                    ...
                                    <div class="jobsearch-candidate-timeline">
                                        <ul class="jobsearch-row">
                                            ...
                                            foreach ($exfield_list as $exfield) {
                                                ...
                                                <li class="jobsearch-column-12">
                                                    <?php
                                                    echo apply_filters('jobsearch_cand_det_resume_expr_list_befre_durtion', '', $candidate_id, $exfield_counter);
                                                    if ($experience_prsnt_datefield_val == 'on') {
                                                        ?>
                                                        <small>
                                                            <?php
                                                            $exp_date_str = jobsearch_get_date_year_only($experience_start_datefield_val) . (' - ') . esc_html__('Present', 'wp-jobsearch');
                                                            echo apply_filters('jobsearch_candet_resume_expr_date_str', $exp_date_str, $candidate_id, $exfield_counter);
                                                            ?>
                                                            <?php echo apply_filters('jobsearch_cand_det_resume_expr_list_inaftr_durtion', '', $candidate_id, $exfield_counter); ?>
                                                        </small>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <small>
                                                            <?php
                                                            $exp_date_str = jobsearch_get_date_year_only($experience_start_datefield_val) . ($experience_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($experience_end_datefield_val) : '');
                                                            echo apply_filters('jobsearch_candet_resume_expr_date_str', $exp_date_str, $candidate_id, $exfield_counter);
                                                            ?>
                                                            <?php echo apply_filters('jobsearch_cand_det_resume_expr_list_inaftr_durtion', '', $candidate_id, $exfield_counter); ?>
                                                        </small>
                                                    ...
                                                    echo apply_filters('jobsearch_cand_det_resume_expr_list_aftr_durtion', '', $candidate_id, $exfield_counter);
                                                    ?>
                                                    <div class="jobsearch-candidate-timeline-text">
                                                        <span><?php echo ($experience_end_companyfield_val) ?></span>
                                                        <?php echo apply_filters('jobsearch_cand_det_resume_axpr_list_aftr_comp', '', $candidate_id, $exfield_counter) ?>
                                                        <h2><a><?php echo jobsearch_esc_html($exfield) ?></a></h2>
                                                        <?php echo apply_filters('jobsearch_cand_det_resume_expr_list_aftr_title', '', $candidate_id, $exfield_counter) ?>
...
echo apply_filters('jobsearch_cand_detail_1_html', $html, $candidate_id);