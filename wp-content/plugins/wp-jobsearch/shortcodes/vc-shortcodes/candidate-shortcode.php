...
if (!class_exists('Jobsearch_Shortcode_Candidates_Frontend')) {
    ...
    class Jobsearch_Shortcode_Candidates_Frontend
    {
        ...
        public function jobsearch_candidates_shortcode_callback($atts, $content = "")
        {
            ...
            if (!isset($atts['cand_filters_loc'])) {
                $atts['cand_filters_loc'] = 'yes';
            }
...
//            }
            ...
            ?>
            <form autocomplete="off" id="jobsearch_candidate_frm_<?php echo absint($candidate_short_counter); ?>">
                <?php
                //
            ...
            if (isset($qrystr) && $qrystr != '') {
                ...
                if (isset($qrystr)) {
                    ...
                    foreach ($qrystr_arr as $qry_var => $qry_val) {
                        ...
                        if (strpos($qry_var, 'nonce') !== false || 'candidate_page' == $qry_var || 'candidate-listing/' == $qry_var || 'q' == $qry_var || 'lang' == $qry_var || 'tab' == $qry_var || 'cand_avail_dates' == $qry_var || 'page_id' == $qry_var || 'per-page' == $qry_var || 'action' == $qry_var || 'ajax_filter' == $qry_var || 'advanced_search' == $qry_var || 'candidate_arg' == $qry_var || 'action' == $qry_var || 'alert-frequency' == $qry_var || 'alerts-name' == $qry_var || 'loc_polygon' == $qry_var || 'alerts-email' == $qry_var || 'loc_polygon_path' == $qry_var) {
                            continue;
                        }
