...
if (isset($featjobs_posts) && !empty($featjobs_posts)) {
    ...
    ?>
    <div class="careerfy-job-listing careerfy-joblisting-plain">
        <ul class="row">
            <?php
            foreach ($featjobs_posts as $fjobs_post) {
                ...
                $job_type_str = function_exists('jobsearch_job_get_all_jobtypes') ? jobsearch_job_get_all_jobtypes($job_id, 'careerfy-joblisting-plain-status careerfy-part-status') : '';
                        ...
                        <div class="careerfy-joblisting-plain-text">
                            <div class="careerfy-joblisting-plain-left">
                                <h2 class="<?php echo($quick_apply_job_btn) ?>"
                                    ...
                                    <a href="<?php echo $quick_apply_job == 'on' && !wp_is_mobile() ? 'javascript:void(0)' : esc_url(get_permalink($job_id)); ?>"
                                       title="<?php echo get_the_title($job_id); ?>">
                                        <?php
                                        $job_title = esc_html(wp_trim_words(get_the_title($job_id), 3));
                                ...
                                <ul>
                                    ...
                                    echo apply_filters('jobsearch_empname_in_joblistin', $comp_name_html, $job_id, 'view-listing2');
                                    ?>
                                    <?php
                                    ...
                                    if ($job_post_date != '' && $job_views_publish_date == 'on') { ?>
                                        <li>
                                            <i class="jobsearch-icon jobsearch-calendar"></i><?php printf(esc_html__('Published %s', 'careerfy'), jobsearch_time_elapsed_string($job_post_date)); ?>
                                        </li>
                                        <?php
                                    }
                                    ...
                                    if ($job_salary != '') { ?>
                                        <li>
                                            <i class="careerfy-icon careerfy-money-line"></i> <?php echo jobsearch_esc_html($job_salary) ?>
                                        </li>
                                    <?php } ?>
                                </ul>
                                <?php
                                $jdetail_html = ob_get_clean();
                                echo apply_filters('jobsearch_listing2_job_left_detail_html', $jdetail_html, $job_id);
                            ...
                            <div class="careerfy-joblisting-plain-right">
                                ...
                                if ($job_city_title != '' && $all_location_allow == 'on') {
                                    ?>
                                    <small>
                                        <i class="careerfy-icon careerfy-map-pin"></i> <?php echo jobsearch_esc_html($job_city_title) ?>
                                    </small>
                                    <?php
                                }
                                ?>
                                ...
                                $book_mark_args = array(
                                    ...
                                    'container_class' => 'careerfy-like-list',
                            ...
                            <?php
                            $_right_html = ob_get_clean();
                            echo apply_filters('jobsearch_listing2_job_listins_right_html', $_right_html, $job_id);
                            ?>
                        ...
                        <div class="careerfy-joblisting-plain-text">
                            <div class="careerfy-joblisting-plain-left">
                                ...
                                <ul>
                                    ...
                                    if ($job_salary != '') {
                                        ?>
                                        <li>
                                            <i class="careerfy-icon careerfy-money-line"></i> <?php echo($job_salary) ?>
                                        </li>
                                        <?php
                                    }
                                    ?>
                            ...
                            <div class="careerfy-joblisting-plain-right">
                                ...
                                if ($job_city_title != '' && $all_location_allow == 'on') {
                                    ?>
                                    <small>
                                        <i class="careerfy-icon careerfy-map-pin"></i> <?php echo($job_city_title) ?>
                                    </small>
                                    <?php
                                }
                                ?>
