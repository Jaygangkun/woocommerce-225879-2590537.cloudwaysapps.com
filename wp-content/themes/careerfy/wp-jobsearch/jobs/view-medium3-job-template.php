 ...
 *
 */
global $jobsearch_post_job_types, $jobsearch_plugin_options, $post;
                    ...
                    <div class="careerfy-joblisting-wrap">
                        ...
                        <div class="careerfy-joblisting-text">
                            <h2 class="<?php echo($quick_apply_job_btn) ?>"
                                ...
                                <a href="<?php echo $quick_apply_job == 'on' && !wp_is_mobile() ? 'javascript:void(0)' : esc_url(get_permalink($job_id)); ?>"
                                   title="<?php echo get_the_title($job_id); ?>">
                                    <?php echo esc_html(wp_trim_words(get_the_title($job_id), 3)); ?>
                                </a>
                                <?php
                            ...
                            if ($job_city_title != '' && $all_location_allow == 'on') { ?>
                                <small><i class="careerfy-icon careerfy-map-pin"></i> <?php echo($job_city_title) ?>
                                </small>
                                <?php
                            }
                        ...
                        if ($jobsearch_job_featured == 'on') {
                            ?>
                            <span class="careerfy-joblisting-view4-featured"><i
                                        class="fa fa-star"></i><?php echo esc_html__('Featured', 'careerfy'); ?></span>
                            <?php
                        } elseif ($elaspedtime > $hourz) {
                            ?>
                            <span class="careerfy-joblisting-view4-date"><?php echo date_i18n(get_option('date_format'), $job_post_date); ?></span>
                        <?php } else { ?>
                            <span class="careerfy-joblisting-view4-new"><?php echo esc_html__('New', 'careerfy'); ?></span>
                            <?php
                        }
                        ?>
                    </div>
...
?>
<div class="careerfy-job-listing careerfy-joblisting-view4" id="jobsearch-job-<?php echo absint($job_short_counter) ?>">
