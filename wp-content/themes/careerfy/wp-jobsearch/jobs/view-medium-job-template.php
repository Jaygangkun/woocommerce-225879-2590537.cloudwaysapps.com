    ...
    <div class="careerfy-job-listing careerfy-featured-listing">
        <ul class="row">
            ...
            foreach ($featjobs_posts as $fjobs_post) {
                ...
                $job_type_str = function_exists('jobsearch_job_get_all_jobtypes') ? jobsearch_job_get_all_jobtypes($job_id, 'careerfy-option-btn') : '';
                ...
                if (function_exists('jobsearch_post_city_contry_txtstr')) {
                    $job_city_title = urldecode(jobsearch_post_city_contry_txtstr($job_id, $loc_view_country, $loc_view_state, $loc_view_city));
                }
                ?>
                <li class="<?php echo($columns_class); ?>">
                    <div class="careerfy-table-layer">
                        <div class="careerfy-table-row">
                            ...
                            echo apply_filters('jobsearch_jobs_listing_emp_img_html', $list_emp_img, $job_id, 'medium');
                            ?>
                            <div class="careerfy-featured-listing-text">
                                <h2 class="<?php echo($quick_apply_job_btn) ?>"
                                    ...
                                    <a href="<?php echo $quick_apply_job == 'on' && !wp_is_mobile() ? 'javascript:void(0)' : esc_url(get_permalink($job_id)); ?>"
                                       title="<?php echo get_the_title($job_id); ?>">
                                        <?php echo esc_html(wp_trim_words(get_the_title($job_id), 10)); ?>
                                    </a>
                                    <?php
                                ...
                                $book_mark_args = array(
                                    ...
                                    'anchor_class' => 'careerfy-like-list',
                                );
                                ...
                                <div class="careerfy-featured-listing-options">
                                    <ul>
                                        ...
                                        if (!empty($sector_str) && $sectors_enable_switch == 'on') {
                                            echo jobsearch_esc_html($sector_str);
                                        }
                                        ?>
                                    </ul>
                                    <?php
