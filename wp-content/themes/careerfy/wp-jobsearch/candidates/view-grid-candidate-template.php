                        ...
                        <figure>
                            ...
                            if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|profile_img')) {
                                if ($post_thumbnail_src != '') { ?> 
                                    <a href="<?php the_permalink(); ?>" class="careerfy-candidate-grid-thumb"><img src="<?php echo ($post_thumbnail_src) ?>" alt=""> <?php if ($candidate_skills == 'on') { ?><span class="careerfy-candidate-grid-status" <?php echo ($final_color) ?>></span><?php } ?></a>
                                    <?php 
                                }
                            } 
                            ?> 
