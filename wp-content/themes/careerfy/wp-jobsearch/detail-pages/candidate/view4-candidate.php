...
if (function_exists('jobsearch_post_city_contry_txtstr') && $cand_det_full_address_switch == 'off') {
...
if ($view_candidate) { ?>
    ...
    <div class="careerfy-candidate-detail-four-subheader" <?php echo($candidate_cover_image_src_style_str); ?>>
        <span class="candidate-detail-four-transparent" style="background: <?php echo $subheader_bg_color ?>"></span>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <figure>
                        ...
                        if (function_exists('jobsearch_member_promote_profile_iconlab')) {
                            echo jobsearch_member_promote_profile_iconlab($candidate_id, 'cand_listv4');
                        }
                        ...
                        <figcaption>
                            ...
                            if ($phone_number_switch != 'off') {
                                ...
                                if ($candidate_phone != '' && !$cand_profile_restrict::cand_field_is_locked('profile_fields|phone', 'detail_page')) {
                                    echo '<span>' . sprintf(esc_html__('Phone: %s', 'wp-jobsearch'), $candidate_phone) . '</span>';
                                }
                            }
                            if (function_exists('jobsearch_cand_urgent_pkg_iconlab')) {
                                echo jobsearch_cand_urgent_pkg_iconlab($candidate_id, 'cand_listv4');
                            }
                            ?>
                            ...
                            if (!$cand_profile_restrict::cand_field_is_locked('socialicons_defields', 'detail_page')) {
                                ...
                                if (!empty($candidate_social_mlinks) || ($cand_alow_fb_smm == 'on' || $cand_alow_twt_smm == 'on' || $cand_alow_gplus_smm == 'on' || $cand_alow_linkd_smm == 'on' || $cand_alow_dribbb_smm == 'on')) {
                                            ...
                                            if (isset($candidate_social_mlinks['title']) && is_array($candidate_social_mlinks['title'])) {
                                                ...
                                                foreach ($candidate_social_mlinks['title'] as $field_title_val) {
                                                    ...
                                                    if ($field_title_val != '' && $cand_dynm_social != '') {
                                                        ?>
                                                        <li><a href="<?php echo esc_url($cand_dynm_social) ?>"
                                    ...
                                    echo apply_filters('jobsearch_cand_detail4_socilinks_html', $cand_socilinks, $candidate_id);
                                }
                            }
                            ?>
                        </figcaption>
                            ...
                            <div class="careerfy-candidate-detail-four-content">
                                    ...
                                    <div class="careerfy-description">
                                        ...
                                        if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|about_desc', 'detail_page')) {
                                            if ($candidate_content != '') {
                                                ?>
                                                <div class="careerfy-content-title">
                                                    <h2><?php esc_html_e('About me', 'careerfy') ?></h2>
                                                </div>
                                                <div class="careerfy-description">
                                ...
                                if (!$cand_profile_restrict::cand_field_is_locked('edu_defields', 'detail_page')) {
                                    ...
                                    if (!empty($exfield_list)) {
                                        ?>
                                        <div class="careerfy-candidate-detail4-title"><h2><i
                                                ...
                                                foreach ($exfield_list as $exfield) {
                                                    ...
                                                    <li class="careerfy-column-12">
                                                        ...
                                                        <div class="candidate-detail4-timeline-text">
                                                            <h2><?php echo jobsearch_esc_html($exfield) ?></h2>
                                                        ...
                                                        <li class="careerfy-column-12">
                                                            <div class="candidate-detail4-timeline-thumb">
                                                                ...
                                                                if ($experience_prsnt_datefield_val == 'on') {
                                                                    ?>
                                                                    <small><?php echo jobsearch_get_date_year_only($experience_start_datefield_val) . (' - ') . esc_html__('Present', 'careerfy') ?></small>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                        ...
                                        if (is_array($exfield_list) && sizeof($exfield_list) > 0) {
                                            ...
                                            <div class="careerfy-candidate-detail4-progressbar">
                                                ...
                                                foreach ($exfield_list as $exfield) {
                                                    ...
                                                    ?>
                                                    <div class="careerfy_progressbar_six"
                                            ...
                                            <div class="candidate-detail4-timeline">
                                                <ul class="careerfy-row">
                                                    ...
                                                    foreach ($exfield_list as $exfield) {
                                                        ...
                                                        <li class="careerfy-column-12">
                                                            <div class="candidate-detail4-timeline-thumb">
                                                                <span><?php echo jobsearch_esc_html($exfield) ?></span>
                                                                <small><?php echo jobsearch_esc_html($award_yearfield_val) ?></small>
                                                            </div>
                                                            <div class="candidate-detail4-timeline-text">
                                                                <h2><?php echo jobsearch_esc_html($exfield) ?></h2>
                                                                <p><?php echo jobsearch_esc_html($exfield_val) ?></p>
