                                                        ...
                                                        <li class="careerfy-column-12">
                                                            <div class="careerfy-candidate-timeline-two-text">
                                                                ...
                                                                if ($experience_prsnt_datefield_val == 'on') {
                                                                    ?>
                                                                    <span><?php echo($experience_end_companyfield_val) ?><small><?php echo jobsearch_get_date_year_only($experience_start_datefield_val) . (' - ') . esc_html__('Present', 'careerfy') ?></small></span>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <span><?php echo($experience_end_companyfield_val) ?><small><?php echo jobsearch_get_date_year_only($experience_start_datefield_val) . ($experience_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($experience_end_datefield_val) : '') ?></small></span>
                                                                    <?php
                                                                }
                                                                ?>
