                                ...
                                <div class="jobsearch_side_box jobsearch_box_jobdetail_three_apply">
                                    <div class="jobsearch_box_jobdetail_three_apply_wrap">
                                        ...
                                        <?php if ($post_thumbnail_src != '') { ?>
                                            <a href="<?php echo get_permalink($postby_emp_id) ?>"><img src="<?php echo esc_url($post_thumbnail_src) ?>" alt=""></a>
                                            <?php
                                        }
                                        ...
                                        <ul class="jobsearch_box_jobdetail_three_apply_list">
                                            ...
                                            if (isset($jobsearch_employer_job_count) && !empty($jobsearch_employer_job_count) && $job_apps_count_switch == 'on') {
